        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group bg-brand-500 text-white px-6 py-4 md:px-8 md:py-5 rounded-full text-base md:text-lg font-medium shadow-2xl shadow-brand-500/30 flex items-center gap-3 mx-auto transition-all hover:bg-brand-400"
            >
