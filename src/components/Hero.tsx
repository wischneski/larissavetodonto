  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center px-4 pt-24 md:pt-20 overflow-hidden">
      ...
      <div className="container mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
        ...
        {/* Text Content - CSS animation instead of framer-motion */}
        <div 
          className="text-left order-2 md:order-1 animate-fade-in-up"
        ...
        {/* Visual/Image - CSS animation */}
        <div 
          className="relative h-full flex justify-center items-center order-1 md:order-2 mb-4 md:mb-0 animate-fade-in"
        ...
        >
          ...
          <div className="relative w-full max-w-[280px] md:max-w-md aspect-3/4 rounded-t-[5rem] md:rounded-t-[10rem] rounded-b-4xl overflow-hidden shadow-2xl border-4 md:border-8 border-white mx-auto">
            ...
            {/* Floating Info Card - CSS animation */}
            <div 
              className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 glass-card p-4 md:p-6 rounded-xl text-center md:text-left animate-fade-in-up"
