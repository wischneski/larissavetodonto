    ...
    <div className="min-h-screen bg-linear-to-br from-brand-50 via-white to-brand-100 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
        ...
        <div className="p-8 md:p-12 text-center">
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ delay: 0.3, type: 'spring', stiffness: 200 }} className="mb-6 md:mb-8">
          ...
          <motion.h2 initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.4 }} className="text-3xl md:text-5xl font-display text-brand-900 mb-4 md:mb-6 leading-tight">
            Obrigado pela sua <span className="italic text-brand-500">Compra!</span>
          </motion.h2>

          <motion.p initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.5 }} className="text-brand-700 text-base md:text-lg leading-relaxed mb-8 md:mb-10 max-w-xl mx-auto">
            Seu acesso ao <strong>Método para Acabar com Mau Hálito do seu Pet</strong> foi enviado para o seu e-mail. Prepare-se para transformar a saúde bucal do seu melhor amigo!
          </motion.p>

          <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.6 }} className="bg-brand-50 rounded-2xl p-6 md:p-8 mb-8 border border-brand-100">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
            <button onClick={() => router.push('/')} className="text-brand-600 hover:text-brand-900 font-medium text-sm underline underline-offset-4 transition-colors">
        ...
        <div className="bg-brand-50 border-t border-brand-100 py-4 px-6 text-center">
          <p className="text-brand-400 text-xs">© 2026 Todos os direitos reservados - VCS Veterinary Care Support</p>
